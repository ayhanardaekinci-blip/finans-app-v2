...
st.set_page_config(
    ...
    page_icon="E",
    layout="wide",
    initial_sidebar_state="collapsed" # Yan menü kapalı başlar
)
...
TR = {
    ...
    "dep_info_desc": "ℹ️ Temmuz 2025 Stopaj Kararnamesi (%17,5 / %15) uygulanmıştır.",
...
with c2:
    # Dil değişince sayfa yenilenir ama Session State sayesinde veriler silinmez.
...
if is_dark:
    ...
    input_text = "#ffffff"
    btn_border = "#495057"
    toggle_color = "#a57afa" # Açık Mor (Karanlıkta parlasın)
else:
    # GÜNDÜZ MODU
    bg_color = "#ffffff"
    card_bg = "#f8f9fa"
    ...
    input_text = "#000000"
    btn_border = "#dee2e6"
    toggle_color = "#6f42c1" # Koyu Mor (Beyazda görünsün)
...
<style>
    ...
    /* 2. Boşlukları Al (Scroll İhtiyacını Azalt) */
    .block-container {{
    ...
    /* 4. Tüm Yazı Renklerini Zorla (Görünmezlik Fix) */
    h1, h2, h3, h4, h5, h6, p, label, span, div, li {{
        color: {text_color} !important;
    }}
    
    /* 5. GECE MODU TİKİ YAZISI (MOR YAPTIK) */
...
if st.session_state.page == "home":
    ...
    if st.button(T("calc"), type="primary", use_container_width=True):
        # YENİ STOPAJ ORANLARI (Temmuz 2025)
